...
export const LEAK_FAMILIES: LeakFamilyDefinition[] = [
  {
    ...
    relatedPackIds: ["bb-co-btn-boundary-defense", "blind-vs-blind-execution"],
  ...
  },
  {
    ...
    relatedPackIds: ["bb-co-btn-boundary-defense", "range-perimeter-pack"],
    relatedFamilies: ["DEFEND_VS_RFI", "BLIND_VS_BLIND"],
  ...
  },
  {
    ...
    tags: ["Ax", "40bb"],
    relatedPackIds: ["40bb-weak-ax-discipline", "range-perimeter-pack"],
  ...
  },
  {
    ...
    tags: ["BTN", "Steal"],
    relatedPackIds: ["range-perimeter-pack"],
    relatedFamilies: ["OPEN_RFI"],
    commonSymptoms: ["BTN folding suited trash that should open", "Missing easy steals"],
    drillRecommendation: "Use Range Perimeter Pack and compare BTN opens to earlier seats.",
    severity: "medium",
    frequency: "watch",
  ...
  },
  {
    ...
    drillRecommendation: "Use Range Perimeter Pack and study the fold side of the button perimeter.",
    severity: "medium",
    frequency: "recurring",
  ...
  },
  {
    ...
    tags: ["Push/Fold", "<=10bb"],
    relatedPackIds: ["push-fold-core"],
    relatedFamilies: ["PUSH_FOLD"],
    commonSymptoms: ["Passing profitable jams", "Calling off too loose from the blind"],
    drillRecommendation: "Enter Push/Fold Mode and drill the current stack bucket.",
    severity: "high",
    frequency: "urgent",
  ...
  },
  {
    ...
    drillRecommendation: "Use Range Perimeter Pack and keep realization front of mind.",
    severity: "medium",
    frequency: "watch",
  ...
  },
  {
    ...
    drillRecommendation: "Use Range Perimeter Pack and compare early opens to HJ/CO.",
    severity: "high",
    frequency: "recurring",
  ...
  },
  {
    ...
    drillRecommendation: "Use Range Perimeter Pack and focus on the in-range side of EP opens.",
    severity: "medium",
    frequency: "watch",
