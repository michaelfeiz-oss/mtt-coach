    ...
    <LocalShell>
      ...
      <section className="mt-4 grid gap-3 sm:grid-cols-2">
        <Link href="/strategy/library">
          <a className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover:border-orange-300">
        ...
        <button
          ...
          className="rounded-2xl border border-orange-200 bg-orange-50 p-5 text-left shadow-sm hover:border-orange-400"
        >
