import { BookOpen, ClipboardList, Database, Dumbbell, FileText, Home, ShieldCheck } from "lucide-react";
...
const NAV = [
  ...
  { href: "/strategy/review-scenarios", label: "Review", icon: ClipboardList },
