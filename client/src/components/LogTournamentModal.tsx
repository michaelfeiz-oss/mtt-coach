...
interface LogTournamentModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function LogTournamentModal({
  isOpen,
  onClose,
  onSubmit,
  isLoading = false,
}: LogTournamentModalProps) {
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, reEntries: e.target.value })
            }
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, startingStack: e.target.value })
            }
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setFormData({ ...formData, finalPosition: value })
            }
          >
